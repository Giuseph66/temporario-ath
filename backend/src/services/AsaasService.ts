...
class AsaasService {
    ...
    constructor(apiKey?: string, baseUrl?: string) {
        ...
        this.baseUrl = baseUrl || process.env.ASAAS_BASE_URL || 'https://sandbox.asaas.com/api/v3';

        if (!this.apiKey) {
            console.warn('⚠️  [AsaasService] ASAAS_API_KEY não configurada. Pagamentos não funcionarão.');
        }
    }
